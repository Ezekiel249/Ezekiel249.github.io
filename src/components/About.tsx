          ...
          <div className="space-y-6 order-1 lg:order-2">
            <div className="prose prose-sm sm:prose-base lg:prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                ...
                using React, Node.js, MSSQL, and the MERN stack, alongside Laravel for robust backend systems. 
                I enjoy transforming ideas into functional, scalable solutions that balance performance, usability, 
                and clean design.
              </p>
              
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                Beyond development, I have a strong background in IT support and networking, which gives me a deeper 
                understanding of system architecture, troubleshooting, and real-world deployment environments.
              </p>

              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                I also bring creativity into my work as a graphic designer, ensuring that the applications I build 
                are not only functional but visually engaging. I'm constantly learning, improving my skills, and 
                exploring new technologies to deliver better digital experiences.
              </p>
            </div>
